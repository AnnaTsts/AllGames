...
---
## Project Overview
We are building BoardGameInPocket app. This is an app to play different easy games with friends by using their phones.

The app includes:
 - Select game
 - Create room for the game
 - Connect to the room
 - Each game should foolow uniqe game rules
 - We need to track scores during the game
...
• make the Ul responsive for different screen sizes
